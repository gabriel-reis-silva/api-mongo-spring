...
public class FuncionarioServiceImpl implements FuncionarioService {
    ...
    public Funcionario postFuncionario(Funcionario funcionario) {
        Beneficio beneficio = this.beneficioRepository.findById(funcionario.getBeneficios().getId())
                .orElseThrow(() ->
                        new IllegalArgumentException
                                ("Benefício de id:" + funcionario.getBeneficios().getId() + " Não encontrado"));
        funcionario.setBeneficios(beneficio);
